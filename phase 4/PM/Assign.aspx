                    ...
                    <td id="Main" valign="top">
                        ...
                        <asp:Panel id="AvailableDevPanel" runat="server">
                            ...
                            <P>
                                ...
                                <asp:RegularExpressionValidator id="ThreshholdTextBoxRegularExpressionValidator" runat="server" ControlToValidate="ThresholdTextBox"
                                    Display="None" ErrorMessage="Please Enter a Number"></asp:RegularExpressionValidator></P>
                            <asp:Label id="ErrorLabel" runat="server" ForeColor="Red"></asp:Label>
                            <asp:DataGrid id="DataGrid1" runat="server" AutoGenerateColumns="False" AlternatingItemStyle-CssClass="dgAltItem"
                                HeaderStyle-CssClass="dgHeader" CssClass="dg">
                                <Columns>
                        ...
                        <asp:Panel id="AssignmentsPanel" runat="server">
                            <H4>Assignments</H4>
                            <asp:DataGrid id="DataGrid2" runat="server" AutoGenerateColumns="False" AlternatingItemStyle-CssClass="dgAltItem"
                                HeaderStyle-CssClass="dgHeader" CssClass="dg">
                                <Columns>
