...
<%@ Page language="c#" Codebehind="Default.aspx.cs" AutoEventWireup="false" Inherits="PMT.Client._Default" %>
        ...
        <form id="Form1" method="post" runat="server">
            <table width="100%" height="100%">
                ...
                <tr>
                    ...
                    <td id="Main" valign="top"><pmt:PageNameControl PageTitle="Client Home" runat="server" id="PageNameControl1" /></td>
                </tr>
            </table>
        </form>
    </body>
