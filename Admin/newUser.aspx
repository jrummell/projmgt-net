<%@ Page language="c#" Codebehind="newUser.aspx.cs" AutoEventWireup="false" Inherits="PMT.Admin.NewUser" %>
                        ...
                        <asp:DataGrid id="NewUserDataGrid" runat="server" CssClass="dg" HeaderStyle-CssClass="dgHeader"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkColumn DataNavigateUrlField="id" DataNavigateUrlFormatString="changeUser.aspx?id={0}&amp;type=new"
                                    DataTextField="usr" HeaderText="User Name"></asp:HyperLinkColumn>
                                <asp:BoundColumn DataField="email" HeaderText="E-Mail"></asp:BoundColumn>
                                <asp:BoundColumn DataField="security" HeaderText="Security Requested"></asp:BoundColumn>
                                <asp:ButtonColumn Text="Decline" ButtonType="PushButton" CommandName="Delete"></asp:ButtonColumn>
                            </Columns>
                        </asp:DataGrid>
                        <asp:Label id="Label1" runat="server">Click on a username to approve a user. Click on the "Decline" button to decline a user.</asp:Label></td>
                </tr>
            </table>
        </form>
    </body>
