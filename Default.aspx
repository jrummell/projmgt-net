<%@ Page language="c#" Codebehind="Default.aspx.cs" AutoEventWireup="false" Inherits="PMT.Default" %>
...
<HTML>
    <HEAD>
        ...
        <pmt:StyleControl runat="server" id="Style1" />
    </HEAD>
    <body>
            ...
            <table width="100%" height="100%">
                ...
                <tr>
                    ...
                    <td id="Main" valign="top">
                        <pmt:PageNameControl PageTitle="Project Management Tool" runat="server" id="PageNameControl1" />
                    </td>
                </tr>
            </table>
        </form>
