<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="false"
    Inherits="PMT.Web.PM.ChooseDevelopers" CodeBehind="ChooseDevelopers.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="phMain" runat="Server">
    <h3>
        Choose Developers</h3>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataSourceID="dsDevelopers"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Competence" DataField="Competence" SortExpression="Competence" />
            <asp:TemplateField HeaderText="Select">
                <ItemTemplate>
                    <asp:CheckBox ID="cbSelected" AutoPostBack="true" OnCheckedChanged="cbSelected_CheckedChanged"
                        runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
