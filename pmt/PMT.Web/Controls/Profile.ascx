...
<table id="Table1" cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        ...
        <td>
            <asp:RequiredFieldValidator ID="FirstNameRequiredFieldValidator" runat="server" ControlToValidate="FirstNameTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your first name."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:RequiredFieldValidator ID="LastNameRequiredFieldValidator" runat="server" ControlToValidate="LastNameTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your last name."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="UsernamePromptLabel" runat="server">Username:</asp:Label>
        </td>
        <td>
        ...
        <td>
            <asp:RequiredFieldValidator ID="UsernameRequiredFieldValidator" runat="server" ControlToValidate="UserNameTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter a username."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CheckBox ID="ChangePasswordCheckBox" runat="server" Text="Change Password" AutoPostBack="True"
                OnCheckedChanged="ChangePasswordCheckBox_CheckedChanged"></asp:CheckBox>
        </td>
        <td>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <asp:RequiredFieldValidator ID="OldPasswordRequiredFieldValidator" runat="server"
                ControlToValidate="OldPasswordTextBox" Display="Dynamic" Text="*" ErrorMessage="Please verify your old password"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="NewPassword1Label" runat="server">New Password:</asp:Label>
        </td>
        <td>
            <asp:TextBox ID="NewPassword1TextBox" runat="server" TextMode="Password"></asp:TextBox>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="Password1RequiredFieldValidator" runat="server" ControlToValidate="NewPassword1TextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter a password."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="NewPassword2Label" runat="server">Re-enter New Password:</asp:Label>
        </td>
        <td>
            <asp:TextBox ID="NewPassword2TextBox" runat="server" TextMode="Password"></asp:TextBox>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="Password2RequiredFieldValidator" runat="server" ControlToValidate="NewPassword2TextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please re-enter your password."></asp:RequiredFieldValidator>
            <asp:CompareValidator ID="PasswordCompareValidator" runat="server" ControlToValidate="NewPassword2TextBox"
                Display="Dynamic" Text="*" ErrorMessage="Your passwords do not match." ControlToCompare="NewPassword1TextBox"></asp:CompareValidator>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <asp:Label ID="AddressLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="AddressRequiredFieldValidator" runat="server" ControlToValidate="AddressTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your address."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <asp:Label ID="CityLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="CityRequiredFieldValidator" runat="server" ControlToValidate="CityTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your city."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <asp:Label ID="StateLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="StateRequiredFieldValidator" runat="server" ControlToValidate="StateTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your state."></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <asp:Label ID="ZipLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="ZipRequiredFieldValidator" runat="server" ControlToValidate="ZipTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your zip code."></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="ZipRegularExpressionValidator" runat="server"
                ControlToValidate="ZipTextBox" Display="Dynamic" Text="*" ErrorMessage="Please enter a valid zip code (ex. 12345 or 12345-1234)."
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Label ID="PhoneLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="PhoneRequiredFieldValidator" runat="server" ControlToValidate="PhoneTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your phone number."></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="PhoneRegularExpressionValidator" runat="server"
                ControlToValidate="PhoneTextBox" Display="Dynamic" Text="*" ErrorMessage="Please enter a valid phone number."
    ...
    <tr>
        ...
        <td>
            <asp:RequiredFieldValidator ID="EmailRequiredFieldValidator" runat="server" ControlToValidate="EmailTextBox"
                Display="Dynamic" Text="*" ErrorMessage="Please enter your email address."></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" runat="server"
                ControlToValidate="EmailTextBox" Display="Dynamic" Text="*" ErrorMessage="Please enter a valid email address."
                ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="SecurityPromptLabel" runat="server">Security:</asp:Label>
        </td>
        <td>
            <asp:DropDownList ID="SecurityDropDownList" runat="server" />
            <asp:Label ID="SecurityLabel" runat="server" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="SecurityRequiredFieldValidator" runat="server" ControlToValidate="SecurityDropDownList"
                Display="Dynamic" Text="*" ErrorMessage="Please select a security level from the list."></asp:RequiredFieldValidator>
        </td>
    </tr>
</table>
