...
namespace PMT.DAL
{
	...
	public partial class Project : ActiveRecord<Project>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Projects", TableType.Table, DataService.GetInstance("SqlServer"));
				...
				DataService.Providers["SqlServer"].AddSchema("Projects",schema);
			}
		}
		#endregion
		...
		public PMT.DAL.ModuleXCollection Modules()
		{
			return new PMT.DAL.ModuleXCollection().Where(ModuleX.Columns.ProjectID, Id).Load();
		}
		public PMT.DAL.ProjectAssignmentCollection ProjectAssignments()
		{
			return new PMT.DAL.ProjectAssignmentCollection().Where(ProjectAssignment.Columns.ProjectID, Id).Load();
		}
		#endregion
		...
		public PMT.DAL.UserCollection GetUserCollection() { return Project.GetUserCollection(this.Id); }
		...
		public static void SaveUserMap(int varId, UserCollection items)
		{
			...
			foreach (User item in items)
			{
				...
				varProjectAssignment.SetColumnValue("UserID", item.GetPrimaryKeyValue());
		...
		/// </summary>
		public static void Insert(string varName,string varDescription,DateTime? varStartDate,DateTime? varExpEndDate,DateTime? varActEndDate)
		{
		...
		/// </summary>
		public static void Update(int varId,string varName,string varDescription,DateTime? varStartDate,DateTime? varExpEndDate,DateTime? varActEndDate)
		{
			Project item = new Project();
